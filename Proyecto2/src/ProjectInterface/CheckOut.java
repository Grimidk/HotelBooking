...
public class CheckOut extends javax.swing.JFrame {
    ...
    private void loadReservationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadReservationActionPerformed
        ...
        while (aux != null){
           ...
           if(reserva.getFirstName().equalsIgnoreCase(fname) & reserva.getLastName().equalsIgnoreCase(lname)){
                History output = Converter.checkOut(fname,lname,myHashtable);
                String data = Parser.reverseParseHistory(output);
                histories[histories.length] = output; 
                CSVreader.putCsv(data, "Booking_hotel - Historico.csv");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckOut(ini).setVisible(true);
            }
        });
    }
