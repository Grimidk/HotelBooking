...
public class Reciever {
    public static Reservation reservationReciever(){
        ...
        while (!Checker.isValiddate(indate) & fname != null) {
        ...
        while (!Checker.isValiddate(outdate) & fname != null) {
            outdate = JOptionPane.showInputDialog(null,"Ingrese una fecha valida: ", "02/01/2000"); 
        }
        while (!Checker.areValiddates(indate,outdate) & fname != null) {
        ...
        while (!Checker.isRoom(room) & fname != null) {
        ...
        while (!Checker.isNum(ci) & Integer.parseInt(ci)>0 & Integer.parseInt(ci)<=999999999 & fname != null) {
        ...
        while (!gender.chars().allMatch(Character::isLetter) & fname != null){
        ...
        while (!email.contains("@") || !email.contains(".") & fname != null){
        ...
        while (!Checker.isValidphone(phone) & fname != null){
